...
- `Version Control Systems` or Soft Conf Mang, e.g., GitHub, Bitbucket
  -   Artifacts: Source code, models, tests, requirements, documentation,...
  -   Meta-information: What, Who, Where, When, Why
- `Issue/Bug tracking systems`: Bugzilla, Jira
...
::: centered
<img src="./figures/shap.png" width="520" height="380"/>
:::
...
- R2021 - approx. 11,600 projects and around 60 attributes related to the project management of software related projects

::: centered
<img src="./figures/isbsg.png" width="660" height="109"/>
:::

`Small data` but difficult to collect though!
...
- EASE (Evaluation and Assessment in Software Engieering)
- Etc.
